...
static const uint8_t colorchange_red[] PROGMEM = {
    ...
    MACRO_WAIT(_BV(CHANNEL_RED)|_BV(CHANNEL_GREEN)|_BV(CHANNEL_BLUE)),
    MACRO_FADE_CHANNEL(CHANNEL_RED, 0, 0x04),
    MACRO_FADE_CHANNEL(CHANNEL_GREEN, 25, 0x04),
    MACRO_WAIT(_BV(CHANNEL_RED)|_BV(CHANNEL_GREEN)|_BV(CHANNEL_BLUE)),
    MACRO_FADE_CHANNEL(CHANNEL_GREEN, 0, 0x04),
    MACRO_FADE_CHANNEL(CHANNEL_BLUE, 25, 0x04),
    MACRO_WAIT(_BV(CHANNEL_RED)|_BV(CHANNEL_GREEN)|_BV(CHANNEL_BLUE)),
    MACRO_FADE_CHANNEL(CHANNEL_BLUE, 0, 0x04),
    MACRO_FADE_CHANNEL(CHANNEL_RED, 25, 0x04),
    MACRO_JUMP(-9)
    };
